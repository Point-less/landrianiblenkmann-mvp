...
urlpatterns = [
    ...
    path('opportunities/provider/<int:opportunity_id>/marketing-packages/new/', views.MarketingPackageCreateView.as_view(), name='marketing-package-create'),
    path('marketing-packages/<int:package_id>/edit/', views.MarketingPackageUpdateView.as_view(), name='marketing-package-edit'),
    path('marketing-packages/<int:package_id>/activate/', views.MarketingPackageActivateView.as_view(), name='marketing-package-activate'),
    path('marketing-packages/<int:package_id>/reserve/', views.MarketingPackageReserveView.as_view(), name='marketing-package-reserve'),
    path('marketing-packages/<int:package_id>/release/', views.MarketingPackageReleaseView.as_view(), name='marketing-package-release'),
